...
- **Monetization**: Account required to scrape; 1 free scrape on signup (preview only — no free ZIP download), then credit packs (3/$4.99, 10/$12.99) or $5.99/mo unlimited subscription via Stripe.
