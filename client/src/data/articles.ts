...
export const articles: Article[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "Click Download ZIP and you'll receive a complete offline backup (first one free, then credits from $1.30)",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "Click Download ZIP to get your complete offline backup (first backup free, then credits from $1.30)",
        ],
      },
      {
    ...
    cta: {
      ...
      body: "Just paste your published Wix URL. Create a free account and your first complete ZIP backup is free — after that, credits start at $1.30 per backup.",
    },
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "Click Download ZIP to get the complete offline backup (first backup free, then credits from $1.30)",
    ...
    cta: {
      ...
      body: "Paste any URL and get a complete offline backup. Your first backup is free — after that, downloads start at $1.30 with a credit pack.",
    },
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Website Sucker crawls any public website and packages every page, image, stylesheet, and file into a single downloadable ZIP — your first backup is free, then credits start at $1.30 per backup. That's it. One URL, one credit, one offline copy that works in any browser without internet.",
        ],
      },
    ],
    cta: {
      heading: "Don't Wait Until Something Goes Wrong",
      body: "Back up your site today. Your first backup is free — after that, credits start at $1.30 per backup.",
    },
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "Click Download ZIP to get everything (first backup free, then credits from $1.30)",
    ...
    cta: {
      ...
      body: "Paste any URL and see every image on your site for free. Download the complete set in a single ZIP — your first backup is free, then credits from $1.30.",
    },
  },
  {
    ...
    cta: {
      ...
      body: "Before you transfer anything, download a complete offline copy of your current site. Your first full ZIP backup is free — after that, credits start at $1.30.",
    },
  },
  {
    ...
    cta: {
      ...
      body: "Paste any URL and get a fully converted static version of your site. Your first complete backup is free — after that, credits start at $1.30.",
    },
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Once the scan is complete, click Download ZIP. Your first backup is free; after that a single credit (from $1.30) unlocks the download. You'll receive a single ZIP file containing every page and asset from your site, organised into a clean folder structure.",
    ...
    cta: {
      ...
      body: "Paste your URL, and download your first complete backup free. Done in under 60 seconds.",
    },
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Analysing any site is free. Your first backup is free, credit packs start at $1.30 per backup, or $5.99/month for unlimited scrapes. No installs, runs in your browser.",
        ],
        list: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Website Sucker is free to use for analysing any site — you see exactly what would be downloaded before paying. Your first backup is free; after that credit packs start at $1.30 per backup, or $5.99/month for unlimited scrapes. If you only need one or two backups, you'll save money. If you need dozens per month, the subscription is the better deal.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "When it finishes, click Download ZIP (first backup free, then credits from $1.30)",
    ...
    cta: {
      ...
      body: "Paste any URL — your first ZIP backup is free, then credits from $1.30. No install, no fuss.",
    },
  },
  {
  ...
  },
  {
    ...
    cta: {
      ...
      body: "Website Sucker is designed for legitimate, polite, personal-use backups. Paste your URL and download — your first backup is free, then credits from $1.30.",
    },
  },
];
